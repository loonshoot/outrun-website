...
3. **Standardization** - Raw data transforms into People, Organizations, Relationships, and Analytics
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  ...
  <a href="/docs/sources/google-search-console/" class="bg-dark-light border border-gray-600  p-6 hover:border-yellow transition-colors">
    ...
    <div class="flex flex-wrap gap-2">
      <span class="px-2 py-1 bg-yellow bg-opacity-20 text-yellow text-xs ">Analytics</span>
    </div>
  </a>

  <a href="/docs/sources/email/" class="bg-dark-light border border-gray-600  p-6 hover:border-yellow transition-colors">
    <div class="flex items-center space-x-4 mb-4">
      <div class="w-12 h-12 bg-pink-500  flex items-center justify-center text-white font-bold text-lg">@</div>
      <div>
        <h3 class="text-yellow text-lg font-semibold">Email</h3>
        <p class="text-gray-400 text-sm">Inbound Email Tracking</p>
      </div>
    </div>
    <p class="text-gray-300 text-sm mb-3">Receive and track inbound emails via MX records or Gmail forwarding.</p>
    <div class="flex flex-wrap gap-2">
      <span class="px-2 py-1 bg-yellow bg-opacity-20 text-yellow text-xs ">Activities</span>
    </div>
  </a>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  ...
  <div class="bg-dark-light border border-gray-600  p-6">
    <h3 class="text-yellow text-lg font-semibold mb-3">📊 Analytics</h3>
    <p class="text-gray-300 mb-3">Search metrics, performance data, and measurable data points.</p>
    <ul class="text-gray-400 text-sm space-y-1">
...
- **Email**: Real-time webhook delivery (no polling)
